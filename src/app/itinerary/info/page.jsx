          ...
          <div className="w-2/3 space-y-6">
                    ...
                    {openDays.includes(day.day) && (
                      ...
                      >
                        <p>
                          ...
                          {day.activities?.morning || "No activity"}
                        </p>
                        <p>
                          ☀️ <strong>Afternoon:</strong>{" "}
                          {day.activities?.afternoon || "No activity"}
                        </p>
                        <p>
                          🌙 <strong>Evening:</strong>{" "}
                          {day.activities?.evening || "No activity"}
                        </p>
                      </motion.div>
                    )}
                  </motion.div>
            ...
            <Card>
              ...
              <CardContent className="text-gray-700 space-y-2">
                <p>
                  🏨 Accommodation: $
                  {itineraryData.itineraryData?.expenses?.daily
                    ?.accommodation || "N/A"}{" "}
                  per day
                </p>
                <p>
          ...
          <div className="w-1/3">
            <Card>
              ...
              <CardContent>
                ...
                {/* Add Review Form (shown when newReview.open is true) */}
                {newReview.open && (
                  <form
